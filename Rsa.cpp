...
BigInt Rsa::encryptByPr(const BigInt& m,const BigInt& in_e,const BigInt& in_n)
{
	return m.moden(in_e,in_n);
}

BigInt Rsa::decodeByPu(const BigInt& m,const BigInt& in_d,const BigInt& in_n)
{
	return m.moden(in_d,in_n);
}